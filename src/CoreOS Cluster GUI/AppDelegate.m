...
//    NSLog(@"applicationDirectory: '%@'", _resoucesPathFromApp);
    ...
    NSString *home_folder = [NSHomeDirectory() stringByAppendingPathComponent:@"coreos-osx-cluster"];
...
//    NSString *app_version = [NSString stringWithFormat:@"%@.%@", version, build];
    ...
    NSString *mText = [NSString stringWithFormat:@"%@ %@", @"CoreOS-Vagrant Cluster GUI for OS X", app_version];
    NSString *infoText = @"It is a simple wrapper around the CoreOS-Vagrant, which allows to control CoreOS-Vagrant Cluster via Status Bar !!!";
